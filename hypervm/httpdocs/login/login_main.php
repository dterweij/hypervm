...
<div class="logo"><img src="/img/loginskin/hypervm.png" alt="HyperVM"></div>
  <div class="login">
          ...
          src="/img/loginskin/user_icon.png" height="20" alt="User"/></td><td><input name="frm_clientname" type="text" class="inputbox" size=30 placeholder="Username" /></td></tr></table></div>
                  <div class="inputfield"><table><tr><td><img
          src="/img/loginskin/password_icon.png" height="20" alt="Mail"/></td><td><input name="frm_password" type="password" class="inputbox" size=30 placeholder="Password" /></td></tr></table></div><br>
  ...
  <div class="forgotpassword"><a class="forgotpwd"  href="javascript:document.forgotpassword.submit()">Forgot Password?</a>
