...
<div class="logo"><img src="/img/loginskin/hypervm.png" alt="HyperVM"></div>
      <div class="login">
              <form name=sendmail action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="inputfield"><table><tr><td><img
                    src="/img/loginskin/mail_icon.png" height="20" alt="Mail"/></td><td><input name="frm_email" type="text" class="inputbox" size=30 placeholder="Email Address" /></td></tr></table></div><br>
