...
$__description["burst:burstable_memory_(MB)_(openvz_only)"] = array("Burst:Burstable Memory (MB) (OpenVZ)");
$__description["cpu:cpu_usage_(%) 100/CPU"] = array("Cpu:Cpu Usage (%) 100/CPU");
$__description["cpuUNIT:CPU_UNITS_(default_1000)"] = array("CPU Units:CPU UNITS (Default 1000)");
$__description["cpuNum:number_of_CPUS"] = array("CPU Number:Number of CPU's");
$__description["ioprio:IO_priority_(0-7)"] = array("IO Prio:IO Priority (0-7) (Default is 4)");
$__description["process:number_of_processes"] = array("Process:Number Of Processes");
$__description["guar:guaranteed_memory_(MB)(openvz_only)"] = array("Guaranteed:Guaranteed Memory (MB) (OpenVZ)");
$__description["memory:memory_usage(MB)(xen_only)"] = array("Memory:Memory Usage (MB) (XEN)");
$__description["traffic:traffic_(MB/month)"] = array("Traffic:Traffic (MB/Month)");
$__description["enable_iptables_(only_for_openvz)"] = array("Enable IPTables (OpenVZ)");
$__description["swap:swap_(MB)"] = array("Swap (MB)");
$__description["enable_vswap"] = array("OpenVZ vSwap");
$__description["can_change_logo"] = array("Can change logo");
$__description["VM_server_pool"] = array("VM Server Pool");
$__description["Ltraffic:traffic_usage_for_last_month_(MB)"] = array("Traffic:Traffic Usage Last Month (MB)");
...
$__description["second_level_quota_(only_for_openvz)"] = array("Second Level Quota (OpenVZ)");
